...
* [Ancient Beast](https://github.com/FreezingMoon/AncientBeast) ⭐ 1,875 | 🐛 443 | 🌐 TypeScript | 📅 2026-09-24 - Match based eSport where players battle themselves by materializing and controling a squad of carefully selected creatures, each having unique stats and abilities. Master your beasts!
...
* [PixiJS](https://github.com/pixijs/pixi.js) ⭐ 48,213 | 🐛 351 | 🌐 TypeScript | 📅 2026-09-23 - The HTML5 Creation Engine: Create beautiful digital content with the fastest, most flexible 2D WebGL renderer.
* [Phaser](https://github.com/photonstorm/phaser) ⭐ 40,353 | 🐛 152 | 🌐 JavaScript | 📅 2026-08-21 - Desktop and Mobile HTML5 game framework. A fast, free and fun open source framework for Canvas and WebGL powered browser games.
* [GDevelop](https://github.com/4ian/GDevelop) ⭐ 26,794 | 🐛 628 | 🌐 JavaScript | 📅 2026-09-23 - An open-source, cross-platform game engine designed to be used by everyone.
...
* [melonJS](https://github.com/melonjs/melonjs) ⭐ 6,399 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-22 - A fresh & lightweight HTML5 game engine.
...
* [KAPLAY](https://github.com/kaplayjs/kaplay) ⭐ 1,801 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-22 - Fork of legacy [Kaboom](https://github.com/replit/kaboom) ⚠️ Archived, that simplifies and accelerates game development by providing an intuitive API and by focusing on creativity rather than complexity.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 115,818 | 🐛 382 | 🌐 JavaScript | 📅 2026-09-24 - JavaScript 3D library.
* [Babylonjs](https://github.com/BabylonJS/Babylon.js) ⭐ 26,101 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-24 - A powerful, beautiful, simple, and open game and rendering engine packed into a friendly JavaScript framework.
* [PlayCanvas](https://github.com/playcanvas/engine) ⭐ 16,907 | 🐛 455 | 🌐 JavaScript | 📅 2026-09-24 - Fast and lightweight WebGL game engine.
...
* [Simplify.js](https://github.com/mourner/simplify-js) ⭐ 2,396 | 🐛 8 | 🌐 JavaScript | 📅 2022-11-14 - A high-performance JavaScript polyline simplification library by Vladimir Agafonkin, extracted from Leaflet.
...
* [ZzFX](https://github.com/KilledByAPixel/ZzFX) ⭐ 792 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-11 - A Tiny JavaScript Sound Effect Engine.
...
* [p5.js](https://github.com/processing/p5.js) ⭐ 24,031 | 🐛 525 | 🌐 JavaScript | 📅 2026-09-24 - A client-side JS platform that empowers artists, designers, students, and anyone to learn to code and express themselves creatively on the web. It is based on the core principles of Processing.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,076 | 🐛 430 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting.

### Physics

* [Matter.js](https://github.com/liabru/matter-js) ⭐ 18,428 | 🐛 278 | 🌐 JavaScript | 📅 2026-09-23 - A JavaScript 2D rigid body physics engine for the web.
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,284 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-22 - 2D JavaScript Physics Engine.
...
* [A-Frame](https://github.com/aframevr/aframe) ⭐ 17,637 | 🐛 340 | 🌐 JavaScript | 📅 2026-07-13 - A web framework for building virtual reality experiences.
...
* [Tiled Map Editor](https://github.com/bjorn/tiled) ⭐ 12,912 | 🐛 837 | 🌐 C++ | 📅 2026-09-21 - A flexible level editor.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,946 | 🐛 123 | 🌐 JavaScript | 📅 2026-09-24 - Bundle JavaScript files for usage in a browser, yet it is also capable of transforming, bundling, or packaging just about any resource or asset.
* [Gulp](https://github.com/gulpjs/gulp) ⭐ 32,928 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-09 - A toolkit to automate & enhance your workflow.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,309 | 🐛 605 | 🌐 JavaScript | 📅 2026-09-24 - A module bundler for JavaScript which compiles small pieces of code into something larger and more complex, such as a library or application.
* [UglifyJS](https://github.com/mishoo/UglifyJS) ⭐ 13,378 | 🐛 45 | 🌐 JavaScript | 📅 2024-11-22 - A JavaScript parser, minifier, compressor and beautifier toolkit.
...
* [Electron](https://github.com/electron/electron) ⭐ 123,228 | 🐛 761 | 🌐 C++ | 📅 2026-09-24 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [NW.js](https://github.com/nwjs/nw.js) ⭐ 41,167 | 🐛 912 | 🌐 JavaScript | 📅 2026-09-23 - Call all Node.js modules directly from DOM/WebWorker and enable a new way of writing applications with all Web technologies.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 16,721 | 🐛 133 | 🌐 TypeScript | 📅 2026-09-21 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web ⚡️
...
* [Babel](https://github.com/babel/babel) ⭐ 44,012 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-18 - The compiler for writing next generation JavaScript.
* [Emscripten: An LLVM-to-Web Compiler](https://github.com/emscripten-core/emscripten) ⭐ 27,628 | 🐛 2,491 | 🌐 C++ | 📅 2026-09-24 - Compiles C and C++ to WebAssembly using LLVM and Binaryen. Emscripten output can run on the Web, in Node.js, and in wasm runtimes.
...
* [CodeCombat: Learn to Code by Playing a Game](https://github.com/codecombat/codecombat) ⭐ 8,571 | 🐛 412 | 🌐 JavaScript | 📅 2026-09-24 - Learn programming with a multiplayer live coding strategy game for beginners.
...
* [Magic Tools](https://github.com/ellisonleao/magictools) ⭐ 17,358 | 🐛 16 | 🌐 Markdown | 📅 2026-09-23 - A list of Game Development resources to make magic happen.
