...
* [Pacman](https://github.com/mumuy/pacman) ⭐ 1,643 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-07 & [Pacman-Game](https://github.com/RishabhDevbanshi/Pacman-Game) ⭐ 64 | 🐛 69 | 🌐 JavaScript | 📅 2020-11-01
...
* [Pixel Art Academy](https://github.com/Retronator/Pixel-Art-Academy) ⭐ 226 | 🐛 10 | 🌐 CoffeeScript | 📅 2026-09-14 - An adventure game for learning to draw.
...
* [Untrusted —or— the Continuing Adventures of Dr. Eval](https://github.com/AlexNisnevich/untrusted) ⭐ 4,662 | 🐛 48 | 🌐 JavaScript | 📅 2025-05-31 - Meta-JavaScript Adventure Game wherein you must edit and re-execute the very JavaScript running the game in your browser to save Dr. Eval from this dark and confusing reality
* [Blitz Tactics](https://github.com/linrock/blitz-tactics) ⭐ 177 | 🐛 38 | 🌐 Ruby | 📅 2026-03-25 - fast-paced chess puzzles
...
* [Ancient Beast](https://github.com/FreezingMoon/AncientBeast) ⭐ 1,873 | 🐛 470 | 🌐 TypeScript | 📅 2026-08-11 - Match based eSport where players battle themselves by materializing and controling a squad of carefully selected creatures, each having unique stats and abilities. Master your beasts!
...
* [Developer portfolio](https://github.com/JSLegendDev/2d-portfolio-kaboom) ⭐ 218 | 🐛 3 | 🌐 JavaScript | 📅 2024-11-12 - Developer portfolio as an interactive 2D game
...
* [PixiJS](https://github.com/pixijs/pixi.js) ⭐ 48,162 | 🐛 344 | 🌐 TypeScript | 📅 2026-09-14 - The HTML5 Creation Engine: Create beautiful digital content with the fastest, most flexible 2D WebGL renderer.
* [Phaser](https://github.com/photonstorm/phaser) ⭐ 40,315 | 🐛 149 | 🌐 JavaScript | 📅 2026-08-21 - Desktop and Mobile HTML5 game framework. A fast, free and fun open source framework for Canvas and WebGL powered browser games.
* [GDevelop](https://github.com/4ian/GDevelop) ⭐ 26,535 | 🐛 625 | 🌐 JavaScript | 📅 2026-09-14 - An open-source, cross-platform game engine designed to be used by everyone.
* [Cocos2d-x](https://github.com/cocos2d/cocos2d-x) ⭐ 19,182 | 🐛 1,604 | 🌐 C++ | 📅 2025-05-09 - A multi-platform framework for building 2d games, interactive books, demos and other graphical applications.
* [melonJS](https://github.com/melonjs/melonjs) ⭐ 6,391 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-15 - A fresh & lightweight HTML5 game engine.
* [Impact](https://github.com/phoboslab/impact) ⭐ 2,127 | 🐛 31 | 🌐 JavaScript | 📅 2024-11-07 - A JavaScript Game Engine that allows you to develop stunning HTML5 Games for desktop and mobile browsers.
* [KAPLAY](https://github.com/kaplayjs/kaplay) ⭐ 1,793 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-13 - Fork of legacy [Kaboom](https://github.com/replit/kaboom) ⚠️ Archived, that simplifies and accelerates game development by providing an intuitive API and by focusing on creativity rather than complexity.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 115,539 | 🐛 378 | 🌐 JavaScript | 📅 2026-09-14 - JavaScript 3D library.
* [Babylonjs](https://github.com/BabylonJS/Babylon.js) ⭐ 26,071 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14 - A powerful, beautiful, simple, and open game and rendering engine packed into a friendly JavaScript framework.
* [PlayCanvas](https://github.com/playcanvas/engine) ⭐ 16,829 | 🐛 496 | 🌐 JavaScript | 📅 2026-09-15 - Fast and lightweight WebGL game engine.
...
* [CindyJS](https://github.com/CindyJS/CindyJS) ⭐ 714 | 🐛 142 | 🌐 JavaScript | 📅 2026-06-19 - A JavaScript framework for interactive (mathematical) content.
...
* [Simplify.js](https://github.com/mourner/simplify-js) ⭐ 2,395 | 🐛 8 | 🌐 JavaScript | 📅 2022-11-14 - A high-performance JavaScript polyline simplification library by Vladimir Agafonkin, extracted from Leaflet.
...
* [ZzFX](https://github.com/KilledByAPixel/ZzFX) ⭐ 786 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-11 - A Tiny JavaScript Sound Effect Engine.
...
* [js13k-2d](https://github.com/kutuluk/js13k-2d) ⭐ 125 | 🐛 2 | 🌐 JavaScript | 📅 2019-02-12 - A 2kb webgl 2d sprite renderer, designed for Js13kGames.
...
* [p5.js](https://github.com/processing/p5.js) ⭐ 23,990 | 🐛 524 | 🌐 JavaScript | 📅 2026-09-14 - A client-side JS platform that empowers artists, designers, students, and anyone to learn to code and express themselves creatively on the web. It is based on the core principles of Processing.
...
* [Matter.js](https://github.com/liabru/matter-js) ⭐ 18,406 | 🐛 278 | 🌐 JavaScript | 📅 2024-08-17 - A JavaScript 2D rigid body physics engine for the web.
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,281 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - 2D JavaScript Physics Engine.
* [p2.js](https://github.com/schteppe/p2.js) ⭐ 2,688 | 🐛 106 | 🌐 JavaScript | 📅 2022-07-09 - 2D rigid body physics engine written in JavaScript.
* [box2d.ts](https://github.com/flyover/box2d.ts) ⭐ 421 | 🐛 27 | 🌐 TypeScript | 📅 2023-06-29 - A TypeScript port of Box2D.

### Virtual Reality

* [A-Frame](https://github.com/aframevr/aframe) ⭐ 17,635 | 🐛 338 | 🌐 JavaScript | 📅 2026-07-13 - A web framework for building virtual reality experiences.

### Audio Resources

* [SoundBox](https://github.com/mbitsnbites/soundbox) ⚠️ Archived - A tool for composing synthetic music, in your browser.
* [TinyMusic](https://github.com/kevincennis/TinyMusic) ⭐ 361 | 🐛 1 | 🌐 JavaScript | 📅 2018-09-14 - A simple, lightweight music synth/sequencer in JavaScript using the Web Audio API.
...
* [Tiled Map Editor](https://github.com/bjorn/tiled) ⭐ 12,887 | 🐛 833 | 🌐 C++ | 📅 2026-09-14 - A flexible level editor.
* [Piskel](https://github.com/piskelapp/piskel) ⭐ 12,784 | 🐛 105 | 🌐 JavaScript | 📅 2026-06-28 - A free online editor for animated sprites & pixel art.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,949 | 🐛 123 | 🌐 JavaScript | 📅 2026-09-14 - Bundle JavaScript files for usage in a browser, yet it is also capable of transforming, bundling, or packaging just about any resource or asset.
* [Gulp](https://github.com/gulpjs/gulp) ⭐ 32,935 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-09 - A toolkit to automate & enhance your workflow.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,308 | 🐛 606 | 🌐 JavaScript | 📅 2026-09-15 - A module bundler for JavaScript which compiles small pieces of code into something larger and more complex, such as a library or application.
...
* [Electron](https://github.com/electron/electron) ⭐ 123,066 | 🐛 765 | 🌐 C++ | 📅 2026-09-15 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [NW.js](https://github.com/nwjs/nw.js) ⭐ 41,165 | 🐛 915 | 🌐 JavaScript | 📅 2026-09-13 - Call all Node.js modules directly from DOM/WebWorker and enable a new way of writing applications with all Web technologies.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 16,669 | 🐛 119 | 🌐 TypeScript | 📅 2026-09-14 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web ⚡️
...
* [Babel](https://github.com/babel/babel) ⭐ 43,997 | 🐛 770 | 🌐 TypeScript | 📅 2026-09-14 - The compiler for writing next generation JavaScript.
* [Emscripten: An LLVM-to-Web Compiler](https://github.com/emscripten-core/emscripten) ⭐ 27,611 | 🐛 2,482 | 🌐 C++ | 📅 2026-09-15 - Compiles C and C++ to WebAssembly using LLVM and Binaryen. Emscripten output can run on the Web, in Node.js, and in wasm runtimes.
...
* [CodeCombat: Learn to Code by Playing a Game](https://github.com/codecombat/codecombat) ⭐ 8,569 | 🐛 419 | 🌐 JavaScript | 📅 2026-09-15 - Learn programming with a multiplayer live coding strategy game for beginners.
...
* [Awesome Web Monetization](https://github.com/thomasbnt/awesome-web-monetization) ⭐ 357 | 🐛 0 | 📅 2026-07-23 - Awesome stuffs about Web Monetization. Learn more, check modules and others tools.
...
* [stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,151 | 🐛 23 | 🌐 JavaScript | 📅 2024-10-11 - JavaScript Performance Monitor.
...
* [Magic Tools](https://github.com/ellisonleao/magictools) ⭐ 17,306 | 🐛 15 | 🌐 Markdown | 📅 2026-09-14 - A list of Game Development resources to make magic happen.
...
* [Awesome PlayCanvas](https://github.com/playcanvas/awesome-playcanvas) ⭐ 488 | 🐛 2 | 📅 2026-09-06 - A curated list of awesome PlayCanvas assets, resources, and more.
