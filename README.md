...
* [Pacman](https://github.com/mumuy/pacman) ⭐ 1,642 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-07 & [Pacman-Game](https://github.com/RishabhDevbanshi/Pacman-Game) ⭐ 64 | 🐛 69 | 🌐 JavaScript | 📅 2020-11-01
...
* [Pixel Art Academy](https://github.com/Retronator/Pixel-Art-Academy) ⭐ 226 | 🐛 10 | 🌐 CoffeeScript | 📅 2026-09-03 - An adventure game for learning to draw.
...
* [Scroll!](https://github.com/ZeevKatz/scroll) ⭐ 28 | 🐛 22 | 🌐 TypeScript | 📅 2022-12-11 - A Face to Face fighting game for mobile that you can play in your browser.
...
* [PixiJS](https://github.com/pixijs/pixi.js) ⭐ 48,115 | 🐛 351 | 🌐 TypeScript | 📅 2026-09-03 - The HTML5 Creation Engine: Create beautiful digital content with the fastest, most flexible 2D WebGL renderer.
* [Phaser](https://github.com/photonstorm/phaser) ⭐ 40,251 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-21 - Desktop and Mobile HTML5 game framework. A fast, free and fun open source framework for Canvas and WebGL powered browser games.
* [GDevelop](https://github.com/4ian/GDevelop) ⭐ 26,180 | 🐛 631 | 🌐 JavaScript | 📅 2026-09-03 - An open-source, cross-platform game engine designed to be used by everyone.
* [Cocos2d-x](https://github.com/cocos2d/cocos2d-x) ⭐ 19,173 | 🐛 1,604 | 🌐 C++ | 📅 2025-05-09 - A multi-platform framework for building 2d games, interactive books, demos and other graphical applications.
* [melonJS](https://github.com/melonjs/melonjs) ⭐ 6,382 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-04 - A fresh & lightweight HTML5 game engine.
...
* [KAPLAY](https://github.com/kaplayjs/kaplay) ⭐ 1,786 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-03 - Fork of legacy [Kaboom](https://github.com/replit/kaboom) ⚠️ Archived, that simplifies and accelerates game development by providing an intuitive API and by focusing on creativity rather than complexity.
...
* [Craters.js](https://github.com/swashvirus/craters.js) ⭐ 26 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-02 - A Compact Game Engine that helps you build fast, modern HTML5 Games.

#### 3D

* [three.js](https://github.com/mrdoob/three.js) ⭐ 115,096 | 🐛 381 | 🌐 JavaScript | 📅 2026-09-03 - JavaScript 3D library.
* [Babylonjs](https://github.com/BabylonJS/Babylon.js) ⭐ 26,016 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-03 - A powerful, beautiful, simple, and open game and rendering engine packed into a friendly JavaScript framework.
* [PlayCanvas](https://github.com/playcanvas/engine) ⭐ 16,613 | 🐛 515 | 🌐 JavaScript | 📅 2026-09-04 - Fast and lightweight WebGL game engine.

### Math

* [big.js](https://github.com/MikeMcl/big.js) ⭐ 5,197 | 🐛 8 | 🌐 JavaScript | 📅 2025-04-22 - A small, fast JavaScript library for arbitrary-precision decimal arithmetic.
...
* [ZzFX](https://github.com/KilledByAPixel/ZzFX) ⭐ 779 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-03 - A Tiny JavaScript Sound Effect Engine.
...
* [p5.js](https://github.com/processing/p5.js) ⭐ 23,940 | 🐛 518 | 🌐 JavaScript | 📅 2026-09-03 - A client-side JS platform that empowers artists, designers, students, and anyone to learn to code and express themselves creatively on the web. It is based on the core principles of Processing.
...
* [Matter.js](https://github.com/liabru/matter-js) ⭐ 18,395 | 🐛 278 | 🌐 JavaScript | 📅 2024-08-17 - A JavaScript 2D rigid body physics engine for the web.
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,277 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - 2D JavaScript Physics Engine.
...
* [A-Frame](https://github.com/aframevr/aframe) ⭐ 17,625 | 🐛 336 | 🌐 JavaScript | 📅 2026-07-13 - A web framework for building virtual reality experiences.
...
* [Tiled Map Editor](https://github.com/bjorn/tiled) ⭐ 12,864 | 🐛 833 | 🌐 C++ | 📅 2026-09-02 - A flexible level editor.
* [Piskel](https://github.com/piskelapp/piskel) ⭐ 12,756 | 🐛 102 | 🌐 JavaScript | 📅 2026-06-28 - A free online editor for animated sprites & pixel art.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,960 | 🐛 140 | 🌐 JavaScript | 📅 2026-09-04 - Bundle JavaScript files for usage in a browser, yet it is also capable of transforming, bundling, or packaging just about any resource or asset.
* [Gulp](https://github.com/gulpjs/gulp) ⭐ 32,942 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-09 - A toolkit to automate & enhance your workflow.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,307 | 🐛 613 | 🌐 JavaScript | 📅 2026-09-04 - A module bundler for JavaScript which compiles small pieces of code into something larger and more complex, such as a library or application.
...
* [Electron](https://github.com/electron/electron) ⭐ 122,863 | 🐛 743 | 🌐 C++ | 📅 2026-09-04 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [NW.js](https://github.com/nwjs/nw.js) ⭐ 41,161 | 🐛 911 | 🌐 JavaScript | 📅 2026-08-19 - Call all Node.js modules directly from DOM/WebWorker and enable a new way of writing applications with all Web technologies.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 16,565 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-02 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web ⚡️
...
* [Babel](https://github.com/babel/babel) ⭐ 43,989 | 🐛 777 | 🌐 TypeScript | 📅 2026-09-04 - The compiler for writing next generation JavaScript.
* [Emscripten: An LLVM-to-Web Compiler](https://github.com/emscripten-core/emscripten) ⭐ 27,594 | 🐛 2,478 | 🌐 C++ | 📅 2026-09-03 - Compiles C and C++ to WebAssembly using LLVM and Binaryen. Emscripten output can run on the Web, in Node.js, and in wasm runtimes.
...
* [CodeCombat: Learn to Code by Playing a Game](https://github.com/codecombat/codecombat) ⭐ 8,556 | 🐛 410 | 🌐 JavaScript | 📅 2026-09-04 - Learn programming with a multiplayer live coding strategy game for beginners.
...
* [Magic Tools](https://github.com/ellisonleao/magictools) ⭐ 17,247 | 🐛 14 | 🌐 Markdown | 📅 2026-09-01 - A list of Game Development resources to make magic happen.
