...
* [Pacman](https://github.com/mumuy/pacman) ⭐ 1,639 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-07 & [Pacman-Game](https://github.com/RishabhDevbanshi/Pacman-Game) ⭐ 64 | 🐛 69 | 🌐 JavaScript | 📅 2020-11-01
...
* [Pixel Art Academy](https://github.com/Retronator/Pixel-Art-Academy) ⭐ 225 | 🐛 10 | 🌐 CoffeeScript | 📅 2026-08-18 - An adventure game for learning to draw.
...
* [Ancient Beast](https://github.com/FreezingMoon/AncientBeast) ⭐ 1,869 | 🐛 463 | 🌐 TypeScript | 📅 2026-08-11 - Match based eSport where players battle themselves by materializing and controling a squad of carefully selected creatures, each having unique stats and abilities. Master your beasts!
...
* [PixiJS](https://github.com/pixijs/pixi.js) ⭐ 48,039 | 🐛 344 | 🌐 TypeScript | 📅 2026-08-19 - The HTML5 Creation Engine: Create beautiful digital content with the fastest, most flexible 2D WebGL renderer.
* [Phaser](https://github.com/photonstorm/phaser) ⭐ 40,170 | 🐛 130 | 🌐 JavaScript | 📅 2026-07-09 - Desktop and Mobile HTML5 game framework. A fast, free and fun open source framework for Canvas and WebGL powered browser games.
* [GDevelop](https://github.com/4ian/GDevelop) ⭐ 25,793 | 🐛 626 | 🌐 JavaScript | 📅 2026-08-19 - An open-source, cross-platform game engine designed to be used by everyone.
* [Cocos2d-x](https://github.com/cocos2d/cocos2d-x) ⭐ 19,148 | 🐛 1,604 | 🌐 C++ | 📅 2025-05-09 - A multi-platform framework for building 2d games, interactive books, demos and other graphical applications.
* [melonJS](https://github.com/melonjs/melonjs) ⭐ 6,365 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-18 - A fresh & lightweight HTML5 game engine.
* [Impact](https://github.com/phoboslab/impact) ⭐ 2,121 | 🐛 31 | 🌐 JavaScript | 📅 2024-11-07 - A JavaScript Game Engine that allows you to develop stunning HTML5 Games for desktop and mobile browsers.
* [KAPLAY](https://github.com/kaplayjs/kaplay) ⭐ 1,775 | 🐛 93 | 🌐 TypeScript | 📅 2026-08-20 - Fork of legacy [Kaboom](https://github.com/replit/kaboom) ⚠️ Archived, that simplifies and accelerates game development by providing an intuitive API and by focusing on creativity rather than complexity.
* [BLACKSMITH 2D](https://github.com/MassiveHeights/Black) ⭐ 211 | 🐛 5 | 🌐 JavaScript | 📅 2023-08-08 - Black is a highly optimized 2D framework for web, mobile games, and playable ads.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,619 | 🐛 374 | 🌐 JavaScript | 📅 2026-08-20 - JavaScript 3D library.
* [Babylonjs](https://github.com/BabylonJS/Babylon.js) ⭐ 25,951 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-14 - A powerful, beautiful, simple, and open game and rendering engine packed into a friendly JavaScript framework.
* [PlayCanvas](https://github.com/playcanvas/engine) ⭐ 16,527 | 🐛 533 | 🌐 JavaScript | 📅 2026-08-20 - Fast and lightweight WebGL game engine.

### Math

* [big.js](https://github.com/MikeMcl/big.js) ⭐ 5,192 | 🐛 8 | 🌐 JavaScript | 📅 2025-04-22 - A small, fast JavaScript library for arbitrary-precision decimal arithmetic.
...
* [p5.js](https://github.com/processing/p5.js) ⭐ 23,881 | 🐛 510 | 🌐 JavaScript | 📅 2026-08-19 - A client-side JS platform that empowers artists, designers, students, and anyone to learn to code and express themselves creatively on the web. It is based on the core principles of Processing.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,065 | 🐛 429 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting.

### Physics

* [Matter.js](https://github.com/liabru/matter-js) ⭐ 18,368 | 🐛 278 | 🌐 JavaScript | 📅 2024-08-17 - A JavaScript 2D rigid body physics engine for the web.
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,269 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - 2D JavaScript Physics Engine.
...
* [A-Frame](https://github.com/aframevr/aframe) ⭐ 17,605 | 🐛 337 | 🌐 JavaScript | 📅 2026-07-13 - A web framework for building virtual reality experiences.
...
* [Tiled Map Editor](https://github.com/bjorn/tiled) ⭐ 12,831 | 🐛 793 | 🌐 C++ | 📅 2026-08-19 - A flexible level editor.
* [Piskel](https://github.com/piskelapp/piskel) ⭐ 12,719 | 🐛 102 | 🌐 JavaScript | 📅 2026-06-28 - A free online editor for animated sprites & pixel art.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,970 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-19 - Bundle JavaScript files for usage in a browser, yet it is also capable of transforming, bundling, or packaging just about any resource or asset.
* [Gulp](https://github.com/gulpjs/gulp) ⭐ 32,950 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-09 - A toolkit to automate & enhance your workflow.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,305 | 🐛 604 | 🌐 JavaScript | 📅 2026-08-16 - A module bundler for JavaScript which compiles small pieces of code into something larger and more complex, such as a library or application.
...
* [Electron](https://github.com/electron/electron) ⭐ 122,586 | 🐛 822 | 🌐 C++ | 📅 2026-08-20 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [NW.js](https://github.com/nwjs/nw.js) ⭐ 41,161 | 🐛 902 | 🌐 JavaScript | 📅 2026-08-19 - Call all Node.js modules directly from DOM/WebWorker and enable a new way of writing applications with all Web technologies.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 16,349 | 🐛 121 | 🌐 TypeScript | 📅 2026-08-20 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web ⚡️
...
* [Babel](https://github.com/babel/babel) ⭐ 43,986 | 🐛 773 | 🌐 TypeScript | 📅 2026-08-16 - The compiler for writing next generation JavaScript.
* [Emscripten: An LLVM-to-Web Compiler](https://github.com/emscripten-core/emscripten) ⭐ 27,574 | 🐛 2,465 | 🌐 C++ | 📅 2026-08-20 - Compiles C and C++ to WebAssembly using LLVM and Binaryen. Emscripten output can run on the Web, in Node.js, and in wasm runtimes.
...
* [JS13K A-Frame Boilerplate](https://github.com/mguinea/js13k-aframe-boilerplate) ⚠️ Archived - An A-Frame boilerplate for the js13k competition.
...
* [CodeCombat: Learn to Code by Playing a Game](https://github.com/codecombat/codecombat) ⭐ 8,546 | 🐛 416 | 🌐 JavaScript | 📅 2026-08-20 - Learn programming with a multiplayer live coding strategy game for beginners.
...
* [Awesome Web Monetization](https://github.com/thomasbnt/awesome-web-monetization) ⭐ 355 | 🐛 0 | 📅 2026-07-23 - Awesome stuffs about Web Monetization. Learn more, check modules and others tools.

### Testing

* [stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,149 | 🐛 22 | 🌐 JavaScript | 📅 2024-10-11 - JavaScript Performance Monitor.
...
* [Magic Tools](https://github.com/ellisonleao/magictools) ⭐ 17,156 | 🐛 13 | 🌐 Markdown | 📅 2026-08-17 - A list of Game Development resources to make magic happen.
