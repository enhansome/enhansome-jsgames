...
* [Pacman](https://github.com/mumuy/pacman) ⭐ 1,644 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-07 & [Pacman-Game](https://github.com/RishabhDevbanshi/Pacman-Game) ⭐ 64 | 🐛 69 | 🌐 JavaScript | 📅 2020-11-01
...
* [Pixel Art Academy](https://github.com/Retronator/Pixel-Art-Academy) ⭐ 226 | 🐛 10 | 🌐 CoffeeScript | 📅 2026-09-17 - An adventure game for learning to draw.
...
* [Untrusted —or— the Continuing Adventures of Dr. Eval](https://github.com/AlexNisnevich/untrusted) ⭐ 4,664 | 🐛 48 | 🌐 JavaScript | 📅 2025-05-31 - Meta-JavaScript Adventure Game wherein you must edit and re-execute the very JavaScript running the game in your browser to save Dr. Eval from this dark and confusing reality
...
* [Ancient Beast](https://github.com/FreezingMoon/AncientBeast) ⭐ 1,875 | 🐛 463 | 🌐 TypeScript | 📅 2026-09-23 - Match based eSport where players battle themselves by materializing and controling a squad of carefully selected creatures, each having unique stats and abilities. Master your beasts!
...
* [Developer portfolio](https://github.com/JSLegendDev/2d-portfolio-kaboom) ⭐ 219 | 🐛 3 | 🌐 JavaScript | 📅 2024-11-12 - Developer portfolio as an interactive 2D game
...
* [PixiJS](https://github.com/pixijs/pixi.js) ⭐ 48,208 | 🐛 345 | 🌐 TypeScript | 📅 2026-09-17 - The HTML5 Creation Engine: Create beautiful digital content with the fastest, most flexible 2D WebGL renderer.
* [Phaser](https://github.com/photonstorm/phaser) ⭐ 40,348 | 🐛 152 | 🌐 JavaScript | 📅 2026-08-21 - Desktop and Mobile HTML5 game framework. A fast, free and fun open source framework for Canvas and WebGL powered browser games.
* [GDevelop](https://github.com/4ian/GDevelop) ⭐ 26,767 | 🐛 630 | 🌐 JavaScript | 📅 2026-09-23 - An open-source, cross-platform game engine designed to be used by everyone.
* [Cocos2d-x](https://github.com/cocos2d/cocos2d-x) ⭐ 19,191 | 🐛 1,604 | 🌐 C++ | 📅 2025-05-09 - A multi-platform framework for building 2d games, interactive books, demos and other graphical applications.
* [melonJS](https://github.com/melonjs/melonjs) ⭐ 6,400 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-22 - A fresh & lightweight HTML5 game engine.
* [Impact](https://github.com/phoboslab/impact) ⭐ 2,130 | 🐛 31 | 🌐 JavaScript | 📅 2024-11-07 - A JavaScript Game Engine that allows you to develop stunning HTML5 Games for desktop and mobile browsers.
* [KAPLAY](https://github.com/kaplayjs/kaplay) ⭐ 1,802 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-22 - Fork of legacy [Kaboom](https://github.com/replit/kaboom) ⚠️ Archived, that simplifies and accelerates game development by providing an intuitive API and by focusing on creativity rather than complexity.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 115,786 | 🐛 379 | 🌐 JavaScript | 📅 2026-09-23 - JavaScript 3D library.
* [Babylonjs](https://github.com/BabylonJS/Babylon.js) ⭐ 26,095 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-22 - A powerful, beautiful, simple, and open game and rendering engine packed into a friendly JavaScript framework.
* [PlayCanvas](https://github.com/playcanvas/engine) ⭐ 16,893 | 🐛 471 | 🌐 JavaScript | 📅 2026-09-23 - Fast and lightweight WebGL game engine.
...
* [ZzFX](https://github.com/KilledByAPixel/ZzFX) ⭐ 791 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-11 - A Tiny JavaScript Sound Effect Engine.
...
* [IonPhaser](https://github.com/proyecto26/ion-phaser) ⭐ 251 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-22 - A web component to use Phaser Framework with Angular, React, Vue, etc 🎮
...
* [p5.js](https://github.com/processing/p5.js) ⭐ 24,026 | 🐛 524 | 🌐 JavaScript | 📅 2026-09-22 - A client-side JS platform that empowers artists, designers, students, and anyone to learn to code and express themselves creatively on the web. It is based on the core principles of Processing.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,077 | 🐛 430 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting.

### Physics

* [Matter.js](https://github.com/liabru/matter-js) ⭐ 18,426 | 🐛 279 | 🌐 JavaScript | 📅 2026-09-22 - A JavaScript 2D rigid body physics engine for the web.
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,283 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-22 - 2D JavaScript Physics Engine.
...
* [A-Frame](https://github.com/aframevr/aframe) ⭐ 17,636 | 🐛 339 | 🌐 JavaScript | 📅 2026-07-13 - A web framework for building virtual reality experiences.
...
* [Snapshot Interpolation](https://github.com/geckosio/snapshot-interpolation) ⭐ 319 | 🐛 6 | 🌐 JavaScript | 📅 2025-02-22 - A Snapshot Interpolation library for Real-Time Multiplayer Games.
...
* [Tiled Map Editor](https://github.com/bjorn/tiled) ⭐ 12,905 | 🐛 836 | 🌐 C++ | 📅 2026-09-21 - A flexible level editor.
* [Piskel](https://github.com/piskelapp/piskel) ⭐ 12,806 | 🐛 93 | 🌐 JavaScript | 📅 2026-09-20 - A free online editor for animated sprites & pixel art.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,948 | 🐛 122 | 🌐 JavaScript | 📅 2026-09-23 - Bundle JavaScript files for usage in a browser, yet it is also capable of transforming, bundling, or packaging just about any resource or asset.
* [Gulp](https://github.com/gulpjs/gulp) ⭐ 32,930 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-09 - A toolkit to automate & enhance your workflow.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,309 | 🐛 605 | 🌐 JavaScript | 📅 2026-09-23 - A module bundler for JavaScript which compiles small pieces of code into something larger and more complex, such as a library or application.
* [UglifyJS](https://github.com/mishoo/UglifyJS) ⭐ 13,379 | 🐛 45 | 🌐 JavaScript | 📅 2024-11-22 - A JavaScript parser, minifier, compressor and beautifier toolkit.
...
* [Electron](https://github.com/electron/electron) ⭐ 123,203 | 🐛 769 | 🌐 C++ | 📅 2026-09-23 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [NW.js](https://github.com/nwjs/nw.js) ⭐ 41,164 | 🐛 912 | 🌐 JavaScript | 📅 2026-09-21 - Call all Node.js modules directly from DOM/WebWorker and enable a new way of writing applications with all Web technologies.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 16,714 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-21 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web ⚡️
...
* [Babel](https://github.com/babel/babel) ⭐ 44,022 | 🐛 767 | 🌐 TypeScript | 📅 2026-09-18 - The compiler for writing next generation JavaScript.
* [Emscripten: An LLVM-to-Web Compiler](https://github.com/emscripten-core/emscripten) ⭐ 27,626 | 🐛 2,489 | 🌐 C++ | 📅 2026-09-22 - Compiles C and C++ to WebAssembly using LLVM and Binaryen. Emscripten output can run on the Web, in Node.js, and in wasm runtimes.
...
* [CodeCombat: Learn to Code by Playing a Game](https://github.com/codecombat/codecombat) ⭐ 8,571 | 🐛 413 | 🌐 JavaScript | 📅 2026-09-23 - Learn programming with a multiplayer live coding strategy game for beginners.
...
* [Immersive](https://github.com/marpi/immersive) ⭐ 39 | 🐛 0 | 🌐 JavaScript | 📅 2017-08-10 - Immersive Three.js Workshop at Gray Area.
...
* [stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,149 | 🐛 23 | 🌐 JavaScript | 📅 2024-10-11 - JavaScript Performance Monitor.
...
* [Magic Tools](https://github.com/ellisonleao/magictools) ⭐ 17,350 | 🐛 16 | 🌐 Markdown | 📅 2026-09-14 - A list of Game Development resources to make magic happen.
