...
* [Pacman](https://github.com/mumuy/pacman) ⭐ 1,641 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-07 & [Pacman-Game](https://github.com/RishabhDevbanshi/Pacman-Game) ⭐ 64 | 🐛 69 | 🌐 JavaScript | 📅 2020-11-01
...
* [Pixel Art Academy](https://github.com/Retronator/Pixel-Art-Academy) ⭐ 226 | 🐛 10 | 🌐 CoffeeScript | 📅 2026-08-18 - An adventure game for learning to draw.
...
* [Untrusted —or— the Continuing Adventures of Dr. Eval](https://github.com/AlexNisnevich/untrusted) ⭐ 4,658 | 🐛 48 | 🌐 JavaScript | 📅 2025-05-31 - Meta-JavaScript Adventure Game wherein you must edit and re-execute the very JavaScript running the game in your browser to save Dr. Eval from this dark and confusing reality
...
* [Ancient Beast](https://github.com/FreezingMoon/AncientBeast) ⭐ 1,875 | 🐛 463 | 🌐 TypeScript | 📅 2026-08-11 - Match based eSport where players battle themselves by materializing and controling a squad of carefully selected creatures, each having unique stats and abilities. Master your beasts!
...
* [PixiJS](https://github.com/pixijs/pixi.js) ⭐ 48,099 | 🐛 344 | 🌐 TypeScript | 📅 2026-08-26 - The HTML5 Creation Engine: Create beautiful digital content with the fastest, most flexible 2D WebGL renderer.
* [Phaser](https://github.com/photonstorm/phaser) ⭐ 40,239 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-21 - Desktop and Mobile HTML5 game framework. A fast, free and fun open source framework for Canvas and WebGL powered browser games.
* [GDevelop](https://github.com/4ian/GDevelop) ⭐ 26,089 | 🐛 628 | 🌐 JavaScript | 📅 2026-08-31 - An open-source, cross-platform game engine designed to be used by everyone.
* [Cocos2d-x](https://github.com/cocos2d/cocos2d-x) ⭐ 19,172 | 🐛 1,604 | 🌐 C++ | 📅 2025-05-09 - A multi-platform framework for building 2d games, interactive books, demos and other graphical applications.
* [melonJS](https://github.com/melonjs/melonjs) ⭐ 6,379 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-31 - A fresh & lightweight HTML5 game engine.
...
* [KAPLAY](https://github.com/kaplayjs/kaplay) ⭐ 1,784 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-31 - Fork of legacy [Kaboom](https://github.com/replit/kaboom) ⚠️ Archived, that simplifies and accelerates game development by providing an intuitive API and by focusing on creativity rather than complexity.
...
* [Craters.js](https://github.com/swashvirus/craters.js) ⭐ 26 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-20 - A Compact Game Engine that helps you build fast, modern HTML5 Games.

#### 3D

* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,961 | 🐛 375 | 🌐 JavaScript | 📅 2026-08-31 - JavaScript 3D library.
* [Babylonjs](https://github.com/BabylonJS/Babylon.js) ⭐ 26,000 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-31 - A powerful, beautiful, simple, and open game and rendering engine packed into a friendly JavaScript framework.
* [PlayCanvas](https://github.com/playcanvas/engine) ⭐ 16,591 | 🐛 527 | 🌐 JavaScript | 📅 2026-08-31 - Fast and lightweight WebGL game engine.

### Math

* [big.js](https://github.com/MikeMcl/big.js) ⭐ 5,194 | 🐛 8 | 🌐 JavaScript | 📅 2025-04-22 - A small, fast JavaScript library for arbitrary-precision decimal arithmetic.
* [CindyJS](https://github.com/CindyJS/CindyJS) ⭐ 712 | 🐛 142 | 🌐 JavaScript | 📅 2026-06-19 - A JavaScript framework for interactive (mathematical) content.
...
* [ZzFX](https://github.com/KilledByAPixel/ZzFX) ⭐ 779 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-11 - A Tiny JavaScript Sound Effect Engine.
* [Hexi](https://github.com/kittykatattack/hexi) ⭐ 561 | 🐛 47 | 🌐 JavaScript | 📅 2019-03-23 - A fun and easy way to make HTML5 games or any other kind interactive media using pure JavaScript code.
...
* [p5.js](https://github.com/processing/p5.js) ⭐ 23,924 | 🐛 511 | 🌐 JavaScript | 📅 2026-08-28 - A client-side JS platform that empowers artists, designers, students, and anyone to learn to code and express themselves creatively on the web. It is based on the core principles of Processing.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,072 | 🐛 429 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting.

### Physics

* [Matter.js](https://github.com/liabru/matter-js) ⭐ 18,389 | 🐛 278 | 🌐 JavaScript | 📅 2024-08-17 - A JavaScript 2D rigid body physics engine for the web.
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,275 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - 2D JavaScript Physics Engine.
...
* [A-Frame](https://github.com/aframevr/aframe) ⭐ 17,621 | 🐛 337 | 🌐 JavaScript | 📅 2026-07-13 - A web framework for building virtual reality experiences.
...
* [Tiled Map Editor](https://github.com/bjorn/tiled) ⭐ 12,859 | 🐛 834 | 🌐 C++ | 📅 2026-08-27 - A flexible level editor.
* [Piskel](https://github.com/piskelapp/piskel) ⭐ 12,745 | 🐛 102 | 🌐 JavaScript | 📅 2026-06-28 - A free online editor for animated sprites & pixel art.
...
* [Audiosprite](https://github.com/tonistiigi/audiosprite) ⭐ 712 | 🐛 28 | 🌐 JavaScript | 📅 2022-10-24 - A ffmpeg wrapper that will take in multiple audio files and combines them into a single file.

### Minification

* [webpack](https://github.com/webpack/webpack) ⭐ 65,962 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-31 - Bundle JavaScript files for usage in a browser, yet it is also capable of transforming, bundling, or packaging just about any resource or asset.
* [Gulp](https://github.com/gulpjs/gulp) ⭐ 32,944 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-09 - A toolkit to automate & enhance your workflow.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,305 | 🐛 606 | 🌐 JavaScript | 📅 2026-08-31 - A module bundler for JavaScript which compiles small pieces of code into something larger and more complex, such as a library or application.
* [UglifyJS](https://github.com/mishoo/UglifyJS) ⭐ 13,382 | 🐛 45 | 🌐 JavaScript | 📅 2024-11-22 - A JavaScript parser, minifier, compressor and beautifier toolkit.
* [Grunt](https://github.com/gruntjs/grunt) ⭐ 12,239 | 🐛 156 | 🌐 JavaScript | 📅 2026-08-14 - The JavaScript Task Runner.
...
* [Electron](https://github.com/electron/electron) ⭐ 122,814 | 🐛 751 | 🌐 C++ | 📅 2026-08-31 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [NW.js](https://github.com/nwjs/nw.js) ⭐ 41,160 | 🐛 905 | 🌐 JavaScript | 📅 2026-08-19 - Call all Node.js modules directly from DOM/WebWorker and enable a new way of writing applications with all Web technologies.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 16,503 | 🐛 123 | 🌐 TypeScript | 📅 2026-08-28 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web ⚡️
...
* [Babel](https://github.com/babel/babel) ⭐ 43,990 | 🐛 777 | 🌐 TypeScript | 📅 2026-08-30 - The compiler for writing next generation JavaScript.
* [Emscripten: An LLVM-to-Web Compiler](https://github.com/emscripten-core/emscripten) ⭐ 27,586 | 🐛 2,479 | 🌐 C++ | 📅 2026-08-30 - Compiles C and C++ to WebAssembly using LLVM and Binaryen. Emscripten output can run on the Web, in Node.js, and in wasm runtimes.
...
* [CodeCombat: Learn to Code by Playing a Game](https://github.com/codecombat/codecombat) ⭐ 8,556 | 🐛 414 | 🌐 JavaScript | 📅 2026-08-31 - Learn programming with a multiplayer live coding strategy game for beginners.
...
* [VR Workshop](https://github.com/marpi/vr) ⭐ 26 | 🐛 1 | 🌐 HTML | 📅 2017-08-10 - VR Workshop at Gray Area Festival.
...
* [Awesome Web Monetization](https://github.com/thomasbnt/awesome-web-monetization) ⭐ 356 | 🐛 0 | 📅 2026-07-23 - Awesome stuffs about Web Monetization. Learn more, check modules and others tools.
...
* [Magic Tools](https://github.com/ellisonleao/magictools) ⭐ 17,221 | 🐛 14 | 🌐 Markdown | 📅 2026-08-29 - A list of Game Development resources to make magic happen.
